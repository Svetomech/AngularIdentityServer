...
namespace QuickstartIdentityServer.Quickstart.Repository
{
  ...
  public class MongoRepository : IRepository
  {
    ...
    {
      _client = new MongoClient(configuration.GetConnectionString("DefaultConnection"));
      _database = _client.GetDatabase(configuration.GetConnectionString("DefaultDatabase"));
    }
